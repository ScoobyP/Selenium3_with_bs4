...
class Web_scraping:
    ...
    def initialise_driver(self):
        ...
        try:
            google_popup = WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((By.ID, "closeSpanId")))
            google_popup.click()
    ...
    def handle_popup(self):
        try:
            google_account_popup_closebutton = WebDriverWait(self.driver, 2).until(EC.visibility_of_element_located((By.ID, "closeSpanId")))
    ...
    def page_load_confirm(self):
        ...
        try:
            ...
            while not is_ready == 'complete':
                ...
                try:
                    WebDriverWait(self.driver, 15).until(EC.visibility_of_all_elements_located((By.CLASS_NAME, "clearfix job-bx wht-shd-bx")))
                except:
            ...
            try:
                ...
                print('ERROR: Height NOT measured')
            ...
            try:
                ...
                print('Number of boxes present: ', len(containers))
            except:
            ...
            while len(containers) < 1:
                ...
                print('PAGE REFRESHED')
                try:
                    WebDriverWait(self.driver, 10).until(EC.visibility_of_all_elements_located((By.CLASS_NAME, "clearfix job-bx wht-shd-bx")))
                except:
                    print('RELOAD TAKING TOO MUCH TIME')
                data = self.driver.page_source
                soup = BeautifulSoup(data, 'lxml')
    ...
    def go_to_next_page(self):
        ...
        try:
            ...
            try:
                ...
                next_button = WebDriverWait(self.driver,15).until(EC.element_to_be_clickable((By.LINK_TEXT, f'{self.page}')))
                print('NEXT PAGE BUTTON VISIBLE')
            except TimeoutException as e:
                print('Immediate NEXT page could NOT be found')
            ...
            try:
                ...
                next_10_button = WebDriverWait(self.driver, 15).until(EC.visibility_of_element_located((By.LINK_TEXT, 'Next 10 pages')))
                
                #WebDriverWait(self.driver, 15).until(EC.visibility_of_element_located((By.LINK_TEXT, 'Next 10 pages')))
                print('NEXT 10 VISIBLE')
    ...
    def main_scrape_data(self):
        ...
        df.to_csv('website_jobs_try3.csv')


print(f' Total time: {round((time.time() -start)/3600, 2)} hours')
